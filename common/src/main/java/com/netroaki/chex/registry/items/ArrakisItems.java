...
import com.netroaki.chex.registry.entities.ArrakisEntities;
...
public class ArrakisItems {
    ...
    // Boss Drops
    public static final RegistryObject<Item> SAND_CORE = ITEMS.register("sand_core",
        () -> new SandCoreItem(
            new Item.Properties()
                .rarity(Rarity.EPIC)
                .stacksTo(1)
    ...
    // Spawn Eggs
    public static final RegistryObject<Item> SHAI_HULUD_SPAWN_EGG = ITEMS.register("shai_hulud_spawn_egg",
        () -> new SpawnEggItem(
