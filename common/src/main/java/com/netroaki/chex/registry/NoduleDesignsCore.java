...
public final class NoduleDesignsCore {
  ...
  public static void initializeDefaults() {
    ...
    THEMES_BY_TIER.put(
        6, new NoduleTheme("spice_melange", List.of("desert_glass", "sandworm_essence")));
    ...
    THEMES_BY_TIER.put(
        9, new NoduleTheme("diamond_core", List.of("pressure_crystals", "ice_crystals")));
    THEMES_BY_TIER.put(
        10, new NoduleTheme("mythic_alloy", List.of("storm_essence", "levitation_essence")));
  }
