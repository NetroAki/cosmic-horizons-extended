...
public final class ArcTessellation {
    ...
    public static void buildArc(Matrix4f matrix, VertexConsumer consumer,
                                 float radius, float thickness, float arcDegrees, int segments,
    ...
    private static void put(VertexConsumer v, Matrix4f m,
