...
public class LaunchDeniedToast implements Toast {
  ...
  @Override
  public Toast.Visibility render(
      GuiGraphics guiGraphics, ToastComponent toastComponent, long time) {
    if (time > displayTime) {
  ...
  public static void show(
      ToastComponent toastComponent, Component title, Component message, ToastType type) {
