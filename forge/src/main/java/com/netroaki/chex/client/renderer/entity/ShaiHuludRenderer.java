...
@OnlyIn(Dist.CLIENT)
public class ShaiHuludRenderer extends MobRenderer<ShaiHuludEntity, ShaiHuludRenderer.ShaiHuludModel> {
    private static final ResourceLocation TEXTURE = new ResourceLocation("chex", "textures/entity/arrakis/shai_hulud.png");
    ...
    @Override
    public void render(ShaiHuludEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, 
    ...
    public static class ShaiHuludModel extends EntityModel<ShaiHuludEntity> {
        public static final ResourceLocation LAYER_LOCATION = new ResourceLocation("chex", "shai_hulud");
        ...
        @Override
        public void setupAnim(ShaiHuludEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
