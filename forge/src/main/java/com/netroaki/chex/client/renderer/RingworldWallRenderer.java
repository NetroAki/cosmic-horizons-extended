...
public class RingworldWallRenderer implements BlockEntityRenderer<RingworldWallBlockEntity> {
  ...
  private static final ResourceLocation SKYBOX_TEXTURE =
      ResourceLocation.fromNamespaceAndPath("minecraft", "textures/environment/end_sky.png");
  ...
  @Override
  public void render(
      RingworldWallBlockEntity blockEntity,
      float partialTick,
      PoseStack poseStack,
  ...
  private void renderBasicCube(
      Matrix4f matrix, VertexConsumer buffer, int packedLight, int packedOverlay) {
    // Render a simple cube with end portal effect
    // Front face
    buffer
        .vertex(matrix, 0.0f, 0.0f, 1.0f)
