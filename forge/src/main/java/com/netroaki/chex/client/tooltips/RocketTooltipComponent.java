...
public class RocketTooltipComponent implements ClientTooltipComponent {
  ...
  public RocketTooltipComponent(
      NoduleTiers rocketTier, String fuelType, int fuelVolume, String[] accessiblePlanets) {
  ...
  public void renderImage(Font font, int x, int y, GuiGraphics guiGraphics) {
    ...
    guiGraphics.drawString(
        font, "Fuel: " + fuelType + " (" + fuelVolume + "mB)", x, y + 10, 0x00AAFF);
