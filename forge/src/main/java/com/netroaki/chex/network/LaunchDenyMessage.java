    ...
    public static void handle(LaunchDenyMessage msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            if (mc.player != null) {
                ...
                mc.player.displayClientMessage(Component.literal(prefix + msg.code + " - " + msg.detail), true);
                // Toast notification
                SystemToast toast = new SystemToast(SystemToast.SystemToastIds.PACK_LOAD_FAILURE,
