...
public abstract class CHEXChunkGenerator extends ChunkGenerator {
    ...
    public static final Codec<CHEXChunkGenerator> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
    ...
    protected static CHEXChunkGenerator create(BiomeSource biomeSource) {
        throw new UnsupportedOperationException("CHEXChunkGenerator base factory is unused; no default generator.");
    }
