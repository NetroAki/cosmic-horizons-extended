...
import com.netroaki.chex.entity.ability.AbilityManager;
import com.netroaki.chex.entity.ability.AbilityRegistry;
import com.netroaki.chex.entity.ability.impl.SporeCloudAbility;
...
public class Sporefly extends Animal implements FlyingAnimal, AbilityRegistry.IAbilityUser {
  private static final EntityDataAccessor<Integer> DATA_COLOR =
      SynchedEntityData.defineId(Sporefly.class, EntityDataSerializers.INT);
  private static final EntityDataAccessor<Integer> DATA_SWARM_SIZE =
      SynchedEntityData.defineId(Sporefly.class, EntityDataSerializers.INT);
  private static final EntityDataAccessor<Boolean> DATA_IS_LEADER =
      SynchedEntityData.defineId(Sporefly.class, EntityDataSerializers.BOOLEAN);

  private static final Ingredient FOOD_ITEMS = Ingredient.of(CHEXItems.LUMINOUS_DUST.get());

  @Nullable private Sporefly swarmLeader;
  ...
  public AbilityManager getAbilityManager() {
    if (this.abilityManager == null) {
      this.abilityManager = new AbilityManager((AbilityRegistry.IAbilityUser) this);
  ...
  static class SporeflyJoinSwarmGoal extends Goal {
    ...
    public boolean canUse() {
      if (this.sporefly.hasSwarmLeader()) {
        ...
        Sporefly leader = list.stream().filter(Sporefly::canBeFollowed).findAny().orElse(null);
      ...
      if (--this.timeToRecalcPath <= 0) {
        ...
        if (leader != null) {
          ...
          if (distanceSq > 16.0D) {
            ...
            this.sporefly.getNavigation().moveTo(awayVec.x, awayVec.y, awayVec.z, 1.0D);
          }
        }
      }
    }
          ...
          List<Sporefly> swarm =
              this.sporefly
                  ...
                  .getEntitiesOfClass(
                      ...
                      (entity) ->
                          entity != this.sporefly && entity.getSwarmLeader() == this.sporefly);
