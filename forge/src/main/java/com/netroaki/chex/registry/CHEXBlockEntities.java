...
public class CHEXBlockEntities {
  ...
  public static final RegistryObject<BlockEntityType<RingworldWallBlockEntity>> RINGWORLD_WALL =
      BLOCK_ENTITIES.register(
          "ringworld_wall",
          () ->
              BlockEntityType.Builder.of(
                      RingworldWallBlockEntity::new,
                      com.netroaki.chex.registry.blocks.CHEXBlocks.RINGWORLD_WALL.get())
                  .build(null));

  public static final RegistryObject<
          BlockEntityType<com.netroaki.chex.ring.blockentity.ArcSceneryBlockEntity>>
      ARC_SCENERY =
          BLOCK_ENTITIES.register(
              "arc_scenery",
              () ->
                  BlockEntityType.Builder.of(
                          com.netroaki.chex.ring.blockentity.ArcSceneryBlockEntity::new,
