...
public class CHEXRegistries {
    ...
    public static final DeferredRegister<net.minecraft.world.item.Item> ITEMS = com.netroaki.chex.registry.items.CHEXItems.ITEMS;
    public static final DeferredRegister<net.minecraft.world.level.block.Block> BLOCKS = com.netroaki.chex.registry.blocks.CHEXBlocks.BLOCKS;
    public static final DeferredRegister<net.minecraft.world.level.material.Fluid> FLUIDS = com.netroaki.chex.registry.fluids.CHEXFluids.FLUIDS;
    public static final DeferredRegister<net.minecraftforge.fluids.FluidType> FLUID_TYPES = com.netroaki.chex.registry.fluids.CHEXFluids.FLUID_TYPES;

    public static void register(net.minecraftforge.eventbus.api.IEventBus eventBus) {
        CHEX.LOGGER.info("Registering CHEX registries...");

        // Register blocks first, then items, then fluids (order matters)
