...
/**
 * Defines the 5 suit tiers for CHEX hazard protection system
 * Based on the checklist: Suits I..V enforce hazards (vacuum, acid, radiation, cryogenic)
 */
public enum SuitTiers {
    SUIT_I("suit1", 1, "Basic Space Suit", 
           EnumSet.of(HazardType.VACUUM), 
           "chex:suits/suit1"),
    SUIT_II("suit2", 2, "Advanced Space Suit", 
            EnumSet.of(HazardType.VACUUM, HazardType.CRYOGENIC), 
            "chex:suits/suit2"),
    SUIT_III("suit3", 3, "Enhanced Space Suit", 
             EnumSet.of(HazardType.VACUUM, HazardType.CRYOGENIC, HazardType.ACID), 
             "chex:suits/suit3"),
    SUIT_IV("suit4", 4, "Superior Space Suit", 
            EnumSet.of(HazardType.VACUUM, HazardType.CRYOGENIC, HazardType.ACID, HazardType.RADIATION), 
            "chex:suits/suit4"),
    SUIT_V("suit5", 5, "Ultimate Space Suit", 
           EnumSet.of(HazardType.VACUUM, HazardType.CRYOGENIC, HazardType.ACID, HazardType.RADIATION, HazardType.EXOTIC), 
           "chex:suits/suit5");
    ...
    SuitTiers(String id, int tier, String displayName, Set<HazardType> protectedHazards, String requiredTagString) {
        this.id = id;
        this.tier = tier;
    ...
    public static void initialize() {
        ...
        for (SuitTiers suit : values()) {
            ...
            suit.requiredTag = TagKey.create(ForgeRegistries.ITEMS.getRegistryKey(),
                    ResourceLocation.parse(suit.requiredTagString));

            CHEX.LOGGER.debug("Initialized {} - {} (protects against: {})",
                    suit.id, suit.displayName, suit.protectedHazards);
        }
