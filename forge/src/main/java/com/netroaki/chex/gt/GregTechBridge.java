...
/** Forge implementation of the GTCEu bridge. */
public final class GregTechBridge implements GtBridge {

  @Override
  public boolean isAvailable() {
    boolean available = ModList.get().isLoaded("gtceu");
    if (available) CHEX.LOGGER.info("GTCEu detected and available for integration");
    else CHEX.LOGGER.info("GTCEu not detected - using fallback systems");
    return available;
  }

  @Override
  public String getGTTierForNoduleTier(int noduleTier) {
    return switch (noduleTier) {
      case 1, 2 -> "LV";
      case 3, 4 -> "MV";
      case 5, 6 -> "HV";
      case 7, 8 -> "EV";
  ...
  @Override
  public String getVeinSizeForNoduleTier(int noduleTier) {
    return switch (noduleTier) {
      case 1, 2 -> "small";
      case 3, 4 -> "medium";
      case 5, 6 -> "large";
  ...
  @Override
  public int getOreCountForNoduleTier(int noduleTier) {
    return switch (noduleTier) {
      case 1, 2 -> 2;
      case 3, 4 -> 4;
      case 5, 6 -> 6;
  ...
  @Override
  public int[] getYRangeForNoduleTier(int noduleTier) {
    return switch (noduleTier) {
      case 1, 2 -> new int[] {-32, 40};
      case 3, 4 -> new int[] {-48, 24};
      case 5, 6 -> new int[] {-64, 8};
      case 7, 8 -> new int[] {-64, -16};
      case 9, 10 -> new int[] {-64, -32};
  ...
  @Override
  public java.util.Map<String, Object> getMineralDataForPlanet(String planetId) {
    if (!isAvailable()) return getFallbackMineralData(planetId);
    return getEnhancedFallbackMineralData(planetId);
  }

  @Override
  public boolean isMineralAvailableOnPlanet(String planetId, String mineral) {
    if (!isAvailable()) return getFallbackMineralData(planetId).containsKey(mineral);
    return getEnhancedFallbackMineralData(planetId).containsKey(mineral);
  }

  @Override
  public int getMineralGTTier(String mineral) {
    if (!isAvailable()) return getFallbackMineralTier(mineral);
  ...
  private static java.util.Map<String, Object> getEnhancedFallbackMineralData(String planetId) {
    ...
    switch (planetId) {
      case "cosmos:earth_moon" -> {
        data.put(
            "silver", java.util.Map.of("tier", 2, "abundance", 0.3, "depth", new int[] {-48, 16}));
        data.put(
            "lead", java.util.Map.of("tier", 2, "abundance", 0.2, "depth", new int[] {-48, 16}));
      }
      case "cosmos:mercury" -> {
        data.put(
            "gold", java.util.Map.of("tier", 3, "abundance", 0.5, "depth", new int[] {-64, 0}));
        data.put(
            "platinum",
            java.util.Map.of("tier", 4, "abundance", 0.1, "depth", new int[] {-64, -16}));
      }
      case "cosmos:mars" -> {
        data.put(
            "nickel", java.util.Map.of("tier", 3, "abundance", 0.4, "depth", new int[] {-48, 8}));
        data.put(
            "cobalt", java.util.Map.of("tier", 3, "abundance", 0.3, "depth", new int[] {-48, 8}));
      }
      case "cosmic_horizons_extended:alpha_centauri_a" -> {
        data.put(
            "titanium",
            java.util.Map.of("tier", 5, "abundance", 0.6, "depth", new int[] {-64, -16}));
        data.put(
            "tungsten",
            java.util.Map.of("tier", 6, "abundance", 0.3, "depth", new int[] {-64, -32}));
      }
      case "cosmic_horizons_extended:kepler_452b" -> {
        ...
        data.put(
            "thorium",
            java.util.Map.of("tier", 7, "abundance", 0.3, "depth", new int[] {-64, -32}));
      }
      case "cosmic_horizons_extended:pandora" -> {
        data.put(
            "unobtanium",
            java.util.Map.of("tier", 6, "abundance", 0.2, "depth", new int[] {-32, 16}));
        data.put(
            "bioluminescent_crystal",
            java.util.Map.of("tier", 6, "abundance", 0.6, "depth", new int[] {-16, 32}));
        data.put(
            "exotic_wood",
            java.util.Map.of("tier", 6, "abundance", 0.8, "depth", new int[] {0, 64}));
      }
      case "cosmic_horizons_extended:pandora_mountains" -> {
        data.put(
            "unobtanium",
            java.util.Map.of("tier", 7, "abundance", 0.4, "depth", new int[] {-48, 48}));
        data.put(
            "magnetic_ore",
            java.util.Map.of("tier", 7, "abundance", 0.5, "depth", new int[] {-32, 32}));
        data.put(
            "crystal_formation",
      ...
      case "cosmic_horizons_extended:pandora_volcanic" -> {
        ...
        data.put(
            "molten_metal",
            java.util.Map.of("tier", 9, "abundance", 0.3, "depth", new int[] {-48, 0}));
        data.put(
            "thermal_energy_core",
      ...
      case "cosmic_horizons_extended:pandora_skylands" -> {
        data.put(
            "sky_crystal",
            java.util.Map.of("tier", 10, "abundance", 0.4, "depth", new int[] {32, 128}));
        data.put(
            "levitation_essence",
            java.util.Map.of("tier", 10, "abundance", 0.2, "depth", new int[] {48, 96}));
        data.put(
            "cloud_metal",
            java.util.Map.of("tier", 10, "abundance", 0.3, "depth", new int[] {16, 80}));
      }
      case "cosmic_horizons_extended:arrakis" -> {
        data.put(
            "spice_melange",
            java.util.Map.of("tier", 6, "abundance", 0.8, "depth", new int[] {-16, 16}));
        data.put(
            "desert_glass",
            java.util.Map.of("tier", 6, "abundance", 0.6, "depth", new int[] {-8, 8}));
        data.put(
            "sandworm_essence",
      ...
      case "cosmic_horizons_extended:arrakis_spice_mines" -> {
        data.put(
            "pure_spice",
            java.util.Map.of("tier", 7, "abundance", 0.9, "depth", new int[] {-48, -16}));
        data.put(
            "crystallized_spice",
            java.util.Map.of("tier", 7, "abundance", 0.4, "depth", new int[] {-64, -32}));
        data.put(
      ...
      case "cosmic_horizons_extended:arrakis_polar_caps" -> {
        data.put(
            "ice_spice",
            java.util.Map.of("tier", 8, "abundance", 0.5, "depth", new int[] {-32, 0}));
        data.put(
            "polar_crystal",
      ...
      case "cosmic_horizons_extended:arrakis_sietch" -> {
        data.put(
            "refined_spice",
            java.util.Map.of("tier", 9, "abundance", 0.8, "depth", new int[] {-32, 0}));
        data.put(
            "sietch_technology",
      ...
      case "cosmic_horizons_extended:arrakis_storm_world" -> {
        data.put(
            "storm_spice",
            java.util.Map.of("tier", 10, "abundance", 0.6, "depth", new int[] {-16, 16}));
        data.put(
            "lightning_crystal",
      ...
      case "cosmic_horizons_extended:ringworld_prime" -> {
        ...
        data.put(
            "metallic_dust",
            java.util.Map.of("tier", 6, "abundance", 0.7, "depth", new int[] {-8, 16}));
        data.put(
            "solar_essence",
            java.util.Map.of("tier", 6, "abundance", 0.4, "depth", new int[] {32, 96}));
        data.put(
            "low_gravity_ore",
      ...
      case "cosmic_horizons_extended:aqua_mundus" -> {
        data.put(
            "ice_core",
            java.util.Map.of("tier", 7, "abundance", 0.9, "depth", new int[] {-64, -32}));
        data.put(
            "underwater_crystals",
        ...
        data.put(
            "frozen_gases",
            java.util.Map.of("tier", 7, "abundance", 0.7, "depth", new int[] {-40, -8}));
        data.put(
            "deep_sea_essence",
      ...
      case "cosmic_horizons_extended:inferno_prime" -> {
        data.put(
            "molten_ore",
            java.util.Map.of("tier", 8, "abundance", 0.8, "depth", new int[] {-16, 16}));
        data.put(
            "obsidian_crystals",
            java.util.Map.of("tier", 8, "abundance", 0.6, "depth", new int[] {-24, 8}));
        data.put(
            "volcanic_glass",
            java.util.Map.of("tier", 8, "abundance", 0.7, "depth", new int[] {-8, 8}));
        data.put(
            "lava_essence",
            java.util.Map.of("tier", 8, "abundance", 0.4, "depth", new int[] {-32, 0}));
        data.put(
      ...
      case "cosmic_horizons_extended:crystalis" -> {
        ...
        data.put(
            "diamond_rain",
            java.util.Map.of("tier", 9, "abundance", 0.1, "depth", new int[] {0, 32}));
        data.put(
            "pressure_crystals",
      ...
      case "cosmic_horizons_extended:stormworld" -> {
        ...
        data.put(
            "wind_energy",
            java.util.Map.of("tier", 10, "abundance", 0.7, "depth", new int[] {24, 88}));
        data.put(
            "gas_giant_core",
