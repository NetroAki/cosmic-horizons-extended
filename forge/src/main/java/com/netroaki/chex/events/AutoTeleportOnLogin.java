...
public final class AutoTeleportOnLogin {
    private static final ResourceKey<Level> AURELIA = ResourceKey.create(Registries.DIMENSION,
    ...
    public void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        if (sp.level().dimension() == Level.OVERWORLD) {
            CHEX.LOGGER.info("Auto-teleporting {} to Aurelia for quick test", sp.getGameProfile().getName());
